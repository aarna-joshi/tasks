...
/**
 * map combined with other arr operations
 * Consume an array of strings and return them as numbers. Note that
 * the strings MAY have "$" symbols at the beginning, in which case
 * those should be removed. If the result cannot be parsed as an integer,
 * convert it to 0 instead.
 */
// Remember, you can write functions as lambdas(ie =>) too! They work exactly the same.
...
/**
 * reduce (the one w complex syntax)
...
export function injectPositive(values: number[]): number[] {
    ...
    valuesCloned.splice(firstNegativeIndex + 1, 0, sumBeforeNegative);
    return valuesCloned;
}
